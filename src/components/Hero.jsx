  ...
  return (
    <section id="hero" className="relative flex min-h-[92vh] items-center overflow-hidden">
      <div className="absolute inset-0 z-0 overflow-hidden bg-black">
        <div className="absolute inset-0 z-10 bg-[radial-gradient(circle_at_top_left,_rgba(255,255,255,0.18),_transparent_30%),radial-gradient(circle_at_85%_18%,_rgba(255,255,255,0.12),_transparent_28%),linear-gradient(110deg,_rgba(0,0,0,0.95)_0%,_rgba(0,0,0,0.78)_42%,_rgba(0,0,0,0.22)_100%)]" />
        <div className="absolute inset-0 z-10 bg-[linear-gradient(to_bottom,rgba(0,0,0,0.16),rgba(0,0,0,0.46)_65%,rgba(0,0,0,0.75))]" />
